...
$usuarios = DB::table('calificaciones')
->leftJoin('alumnos','calificaciones.idalumno', '=', 'alumnos.id.alumno')
->get();
...
foreach($users as $fila){
    ...
    <tr>
        ...
        <td><a class='button' href='borrar.php?id={$fila->idcalificacion}'>ELIMINAR </a></td>
        <td>
...
echo "</tbody></table>
<a class='button' href='iniciosesion.html'>REGRESAR</a>";
